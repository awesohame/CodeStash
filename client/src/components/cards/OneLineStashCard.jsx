        ...
        <div className={twMerge("", className)}>
            {
                stashes.slice(0, 4).map(stash => (
                    ...
                    >
                        <div className="flex items-center justify-between my-2 px-8 py-4 w-full bg-[#293040] text-gray-300 rounded-lg hover:bg-[#202632] hover:text-gray-300 transition-colors duration-200 ease-in-out">
                            ...
                            <div className="w-[40%] text-gray-400 font-thin">
                                {stash.description?.substring(0, 27)?.trim()}
