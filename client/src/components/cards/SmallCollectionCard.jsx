        ...
        <div className={twMerge("", className)}>
            {
                collections.slice(0, 2).map(collection => (
                    ...
                    >
                        <div className="flex flex-col items-center justify-between h-full my-2 px-4 py-[0.9rem] w-full bg-[#293040] text-gray-300 rounded-lg hover:bg-[#202632] hover:text-gray-300 transition-colors duration-200 ease-in-out">
                            <div className="flex h-[50%] w-full items-center">
                                <div className="grow font-semibold text-lg/6">
                                    {collection.title?.substring(0, 40)?.trim()}
                                    {collection.title?.length > 40 && '...'}
                                </div>
                            </div>
                            <div className="w-full text-sm flex my-1 items-center">
                                {
                            ...
                            {/* <div className="h-[50%] w-full text-gray-400 font-thin text-sm">
